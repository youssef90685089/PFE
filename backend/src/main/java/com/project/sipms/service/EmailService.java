...
public class EmailService {
    ...
    @Value("${app.email.from:ayadi9732@gmail.com}")
    ...
    public void sendWelcomeEmail(String to, String name, String tempPassword, String loginUrl) {
        if (!emailEnabled) {
            log.info("Email disabled — skipping welcome email for {}", to);
            return;
        }
        String subject = "Welcome to CLINISYS — Your Account Has Been Created";
