...
\begin{itemize}[leftmargin=2cm, topsep=4pt]
    \begin{spacing}{1.25}
        ...
        \item \textbf{AI-powered CV analysis}: Candidates can upload their CV documents and receive automated skill extraction, project matching recommendations, and personalized 4-week roadmaps.
        \item \textbf{Comprehensive audit trail}: All system actions are logged and viewable by administrators, ensuring full traceability and compliance.
    \end{spacing}
\end{itemize}
