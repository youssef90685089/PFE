...
\begin{itemize}[leftmargin=2cm, topsep=0pt]
    \begin{spacing}{1.25}
        ...
        \item Real-time automated notifications are sent to the Manager immediately upon quiz submission.
    \end{spacing}
\end{itemize}
...
\begin{itemize}[leftmargin=2cm, topsep=0pt]
    \begin{spacing}{1.25}
        \item Managers and Admins can configure projects with titles, descriptions, and technology tags.
        \item Candidates can propose projects which are then evaluated by the AI engine.
    \end{spacing}
\end{itemize}
...
\hline
\end{tabular}
\caption{Use case: AI-powered project ranking}
\end{table}
