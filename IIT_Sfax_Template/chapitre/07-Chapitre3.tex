...
This sequence describes the complete candidate registration and document upload flow performed by the receptionist. This sequence diagram corresponds to Use Case: \textbf{Register a New Candidate} and \textbf{Add Internship File with Document}.
...
This sequence diagram corresponds to Use Case: \textbf{Approve and Send Quiz} (User Story US-18).
\begin{enumerate}
...
This sequence diagram corresponds to Use Case: \textbf{Schedule Interview} and \textbf{Record Interview Result} (User Stories US-19 and US-20).
\begin{enumerate}
    \item Manager identifies a candidate whose application is in \texttt{QUIZ\_COMPLETED} status AND who has passed the quiz (\texttt{passed = true}).
